...
const postReceiveFunction1 = function (items, response) {
    return __awaiter(this, void 0, void 0, function* () {
        items.forEach((item) => (item.json1 = { success: true }));
        return items;
    });
};
const preSendFunction1 = function (requestOptions) {
    return __awaiter(this, void 0, void 0, function* () {
    ...
    describe('getRequestOptionsFromParameters', () => {
        ...
        for (const testData of tests) {
            test(testData.description, () => {
                ...
                const executeSingleFunctions = Helpers.getExecuteSingleFunctions(workflow, runExecutionData, runIndex, connectionInputData, {}, node, itemIndex, additionalData, {
                    node,
                    data: {},
                    source: null,
                }, mode);
    ...
    describe('runNode', () => {
        ...
        for (const testData of tests) {
            test(testData.description, () => __awaiter(void 0, void 0, void 0, function* () {
                const node = Object.assign(Object.assign({}, baseNode), testData.input.node);
                const workflowData = {
                    nodes: [node],
                    connections: {},
                };
                // @ts-ignore
                nodeType.description = Object.assign({}, testData.input.nodeType);
                const workflow = new src_1.Workflow({
                    nodes: workflowData.nodes,
                    connections: workflowData.connections,
                    active: false,
                ...
                const nodeExecuteFunctions = {
                    getExecuteFunctions: () => {
                        return Helpers.getExecuteFunctions(workflow, runExecutionData, runIndex, connectionInputData, {}, node, itemIndex, additionalData, executeData, mode);
                    },
                    getExecuteSingleFunctions: () => {
                        return Helpers.getExecuteSingleFunctions(workflow, runExecutionData, runIndex, connectionInputData, {}, node, itemIndex, additionalData, executeData, mode);
                    },
                };
                const result = yield routingNode.runNode(inputData, runIndex, nodeType, executeData, nodeExecuteFunctions);
                expect(result).toEqual(testData.output);
            }));
        }
    });
        ...
        for (const testData of tests) {
            test(testData.description, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                for (let iteration = 0; iteration < inputData.main[0].length; iteration++) {
                    ...
                    const nodeExecuteFunctions = {
                        getExecuteFunctions: () => {
                            return Helpers.getExecuteFunctions(workflow, runExecutionData, runIndex, connectionInputData, {}, node, itemIndex + iteration, additionalData, executeData, mode);
                        },
                        getExecuteSingleFunctions: () => {
                            return Helpers.getExecuteSingleFunctions(workflow, runExecutionData, runIndex, connectionInputData, {}, node, itemIndex + iteration, additionalData, executeData, mode);
                        },
                    };
                    const routingNodeExecutionContext = nodeExecuteFunctions.getExecuteSingleFunctions(routingNode.workflow, routingNode.runExecutionData, runIndex, routingNode.connectionInputData, inputData, routingNode.node, iteration, routingNode.additionalData, executeData, routingNode.mode);
