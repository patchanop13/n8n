            ...
            if (mode === 'append') {
                ...
                for (entry1 of dataInput1) {
                    for (entry2 of dataInput2) {
                        returnData.push({
                            json: Object.assign(Object.assign({}, (entry1.json)), (entry2.json)),
                            pairedItem: [
                                entry1.pairedItem,
                                entry2.pairedItem,
                            ],
                ...
                for (entry of dataInput2) {
                    const key = (0, lodash_1.get)(entry.json, propertyName2);
                    if (!entry.json || !key) {
                ...
                for (entry of dataInput1) {
                    referenceValue = (0, lodash_1.get)(entry.json, propertyName1);
