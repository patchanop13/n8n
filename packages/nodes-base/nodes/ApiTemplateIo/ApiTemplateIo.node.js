            ...
            loadOptions: {
                getImageTemplates() {
                    return __awaiter(this, void 0, void 0, function* () {
                        return yield GenericFunctions_1.loadResource.call(this, 'image');
                    });
                },
                getPdfTemplates() {
                    return __awaiter(this, void 0, void 0, function* () {
                        return yield GenericFunctions_1.loadResource.call(this, 'pdf');
                    });
                },
            },
        };
            ...
            if (resource === 'account') {
                ...
                if (operation === 'get') {
                    ...
                    for (let i = 0; i < length; i++) {
                        try {
                            responseData = yield GenericFunctions_1.apiTemplateIoApiRequest.call(this, 'GET', '/account-information');
                ...
                if (operation === 'create') {
                    ...
                    for (let i = 0; i < length; i++) {
                        try {
                            ...
                            responseData = yield GenericFunctions_1.apiTemplateIoApiRequest.call(this, 'POST', '/create', qs, body);
                            if (download === true) {
                                const binaryProperty = this.getNodeParameter('binaryProperty', i);
                                const data = yield GenericFunctions_1.downloadImage.call(this, responseData.download_url);
                                const fileName = responseData.download_url.split('/').pop();
                                const binaryData = yield this.helpers.prepareBinaryData(data, options.fileName || fileName);
                                responseData = {
                                    json: responseData,
                                    binary: {
                ...
                if (operation === 'create') {
                    ...
                    for (let i = 0; i < length; i++) {
                        try {
                            ...
                            responseData = yield GenericFunctions_1.apiTemplateIoApiRequest.call(this, 'POST', '/create', qs, data);
                            if (download === true) {
                                const binaryProperty = this.getNodeParameter('binaryProperty', i);
                                const data = yield GenericFunctions_1.downloadImage.call(this, responseData.download_url);
                                const fileName = responseData.download_url.split('/').pop();
