            ...
            loadOptions: {
                ...
                getPages() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const { slides } = yield GenericFunctions_1.googleApiRequest.call(this, 'GET', `/presentations/${presentationId}`, {}, { fields: 'slides' });
                ...
                try {
                    if (resource === 'page') {
                        ...
                        if (operation === 'get') {
                            ...
                            responseData = yield GenericFunctions_1.googleApiRequest.call(this, 'GET', `/presentations/${presentationId}/pages/${pageObjectId}`);
                            ...
                            const presentationId = this.getNodeParameter('presentationId', i);
                            const pageObjectId = this.getNodeParameter('pageObjectId', i);
                            responseData = yield GenericFunctions_1.googleApiRequest.call(this, 'GET', `/presentations/${presentationId}/pages/${pageObjectId}/thumbnail`);
                            const download = this.getNodeParameter('download', 0);
                            if (download === true) {
                                const binaryProperty = this.getNodeParameter('binaryProperty', i);
                                const data = yield this.helpers.request({
                                ...
                                const binaryData = yield this.helpers.prepareBinaryData(data, fileName || fileName);
                                returnData.push({
                                    json: responseData,
                                    binary: {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.googleApiRequest.call(this, 'POST', '/presentations', body);
                            returnData.push({ json: responseData });
                        }
                            ...
                            // ----------------------------------
                            const presentationId = this.getNodeParameter('presentationId', i);
                            responseData = yield GenericFunctions_1.googleApiRequest.call(this, 'GET', `/presentations/${presentationId}`);
                            returnData.push({ json: responseData });
                        }
                            ...
                            const presentationId = this.getNodeParameter('presentationId', i);
                            responseData = yield GenericFunctions_1.googleApiRequest.call(this, 'GET', `/presentations/${presentationId}`, {}, { fields: 'slides' });
                            ...
                            responseData = yield GenericFunctions_1.googleApiRequest.call(this, 'POST', `/presentations/${presentationId}:batchUpdate`, { requests });
                            returnData.push({ json: responseData });
                        }
                    }
                }
