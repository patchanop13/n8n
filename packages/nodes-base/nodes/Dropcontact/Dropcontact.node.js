...
class Dropcontact {
    constructor() {
        ...
        this.methods = {
            credentialTest: {
                dropcontactApiCredentialTest(credential) {
                    return __awaiter(this, void 0, void 0, function* () {
                        try {
                            yield GenericFunction_1.validateCredentials.call(this, credential.data);
                        }
                        catch (error) {
                            return {
                                status: 'Error',
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (resource === 'contact') {
                if (operation === 'enrich') {
                    ...
                    responseData = (yield GenericFunction_1.dropcontactApiRequest.call(this, 'POST', '/batch', { data, siren, language }, {}));
                    ...
                    if (simplify === false) {
                        ...
                        responseData = yield GenericFunction_1.dropcontactApiRequest.call(this, 'GET', `/batch/${responseData.request_id}`, {}, {});
                        if (!responseData.success) {
                            if (this.continueOnFail()) {
                ...
                if (operation === 'fetchRequest') {
                    for (let i = 0; i < entryData.length; i++) {
                        ...
                        responseData = (yield GenericFunction_1.dropcontactApiRequest.call(this, 'GET', `/batch/${requestId}`, {}, {}));
                        if (!responseData.success) {
                            if (this.continueOnFail()) {
