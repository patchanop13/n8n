...
const makeGetAllFields = (resource) => {
    const loadOptionsMethod = `get${(0, GenericFunctions_1.capitalizeInitial)(resource)}Fields`;
    return [
        {
...
const makeCustomFieldsFixedCollection = (resource) => {
    const loadOptionsMethod = `getCustom${(0, GenericFunctions_1.capitalizeInitial)(resource)}Fields`;
    return {
