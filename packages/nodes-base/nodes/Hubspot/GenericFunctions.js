...
function hubspotApiRequest(method, endpoint, body = {}, query = {}, uri) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (authenticationMethod === 'apiKey') {
                const credentials = yield this.getCredentials('hubspotApi');
                options.qs.hapikey = credentials.apiKey;
                return yield this.helpers.request(options);
            }
            else if (authenticationMethod === 'appToken') {
                const credentials = yield this.getCredentials('hubspotAppToken');
                ...
                if (endpoint.includes('webhooks')) {
                    ...
                    return yield this.helpers.requestOAuth2.call(this, 'hubspotDeveloperApi', options, { tokenType: 'Bearer', includeCredentialsOnRefreshOnBody: true });
                }
            }
            else {
                return yield this.helpers.requestOAuth2.call(this, 'hubspotOAuth2Api', options, { tokenType: 'Bearer', includeCredentialsOnRefreshOnBody: true });
            }
        }
        catch (error) {
 ...
 */
function hubspotApiRequestAllItems(propertyName, method, endpoint, body = {}, query = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const returnData = [];
        let responseData;
        ...
        do {
            responseData = yield hubspotApiRequest.call(this, method, endpoint, body, query);
...
const getEmailMetadata = (meta) => {
    return Object.assign(Object.assign(Object.assign({ from: Object.assign(Object.assign(Object.assign({}, (meta.fromEmail && { email: meta.fromEmail })), (meta.firstName && { firstName: meta.firstName })), (meta.lastName && { lastName: meta.lastName })), cc: reduceMetadatFields(meta.cc || []), bcc: reduceMetadatFields(meta.bcc || []) }, (meta.subject && { subject: meta.subject })), (meta.html && { html: meta.html })), (meta.text && { text: meta.text }));
};
exports.getEmailMetadata = getEmailMetadata;
const getTaskMetadata = (meta) => {
    return Object.assign(Object.assign(Object.assign(Object.assign({}, (meta.body && { body: meta.body })), (meta.subject && { subject: meta.subject })), (meta.status && { status: meta.status })), (meta.forObjectType && { forObjectType: meta.forObjectType }));
};
exports.getTaskMetadata = getTaskMetadata;
const getMeetingMetadata = (meta) => {
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (meta.body && { body: meta.body })), (meta.startTime && { startTime: (0, moment_1.default)(meta.startTime).unix() })), (meta.endTime && { endTime: (0, moment_1.default)(meta.endTime).unix() })), (meta.title && { title: meta.title })), (meta.internalMeetingNotes && { internalMeetingNotes: meta.internalMeetingNotes }));
};
exports.getMeetingMetadata = getMeetingMetadata;
const getCallMetadata = (meta) => {
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (meta.toNumber && { toNumber: meta.toNumber })), (meta.fromNumber && { fromNumber: meta.fromNumber })), (meta.status && { status: meta.status })), (meta.durationMilliseconds && { durationMilliseconds: meta.durationMilliseconds })), (meta.recordingUrl && { recordingUrl: meta.recordingUrl })), (meta.body && { body: meta.body }));
};
exports.getCallMetadata = getCallMetadata;
const getAssociations = (associations) => {
    return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (associations.companyIds && { companyIds: associations.companyIds.toString().split(',') })), (associations.contactIds && { contactIds: associations.contactIds.toString().split(',') })), (associations.dealIds && { dealIds: associations.dealIds.toString().split(',') })), (associations.ownerIds && { ownerIds: associations.ownerIds.toString().split(',') })), (associations.ticketIds && { ticketIds: associations.ticketIds.toString().split(',') }));
};
