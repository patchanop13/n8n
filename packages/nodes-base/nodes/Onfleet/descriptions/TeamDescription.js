...
exports.teamFields = [
    ...
    Object.assign(Object.assign({}, workersField), { displayOptions: {
            show: {
                resource: [
                    'team',
                ],
    ...
    Object.assign(Object.assign({}, managersField), { displayOptions: {
            show: {
                resource: [
                    'team',
                ],
                ...
                options: [
                    {
                        ...
                        default: {},
                        values: [
                            Object.assign(Object.assign({}, routeEndField), { required: true }),
                            Object.assign(Object.assign({}, hubField), { displayOptions: {
                                    show: {
                                        routeEnd: [
                                            'hub',
                                        ],
                ...
                options: [
                    {
                        ...
                        default: {},
                        values: [
                            Object.assign(Object.assign({}, longitudeDropOffField), { required: true }),
                            Object.assign(Object.assign({}, latitudeDropOffField), { required: true }),
                        ],
                    },
                ],
            },
                ...
                options: [
                    {
                        ...
                        default: {},
                        values: [
                            Object.assign(Object.assign({}, longitudePickupField), { required: true }),
                            Object.assign(Object.assign({}, latitudePickupField), { required: true }),
                            Object.assign(Object.assign({}, pickupTimeField), { required: false }),
                        ],
                    },
                ],
            },
            Object.assign(Object.assign({}, restrictedVehicleTypesField), { required: false }),
            Object.assign(Object.assign({}, serviceTimeEstimateField), { required: false }),
        ],
    },
];
