        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (authenticationMethod === 'accessToken') {
                    credentials = yield this.getCredentials('gitlabApi');
                }
                else {
                    credentials = yield this.getCredentials('gitlabOAuth2Api');
                }
            }
            catch (error) {
            ...
            for (let i = 0; i < items.length; i++) {
                try {
                    ...
                    if (returnAll === true) {
                        responseData = yield GenericFunctions_1.gitlabApiRequestAllItems.call(this, requestMethod, endpoint, body, qs);
                    }
                    else {
                        responseData = yield GenericFunctions_1.gitlabApiRequest.call(this, requestMethod, endpoint, body, qs);
                    }
