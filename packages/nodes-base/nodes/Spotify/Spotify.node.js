                ...
                try {
                    if (resource === 'player') {
                        ...
                        if (operation === 'pause') {
                            ...
                            responseData = yield GenericFunctions_1.spotifyApiRequest.call(this, requestMethod, endpoint, body, qs);
                        ...
                        if (['delete', 'get', 'getTracks', 'add'].includes(operation)) {
                            ...
                            responseData = yield GenericFunctions_1.spotifyApiRequest.call(this, 'POST', '/me/playlists', body, qs);
                        }
                        else if (operation === 'search') {
                            requestMethod = 'GET';
                            endpoint = '/search';
                    ...
                    if (returnAll) {
                        responseData = yield GenericFunctions_1.spotifyApiRequestAllItems.call(this, propertyName, requestMethod, endpoint, body, qs);
                    }
