...
class Workflow {
     ...
     * @memberof Workflow
     */
    runWebhookMethod(method, webhookData, nodeExecuteFunctions, mode, activation, isTest) {
     ...
     * @memberof Workflow
     */
    runTrigger(node, getTriggerFunctions, additionalData, mode, activation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (mode === 'manual') {
                ...
                const triggerResponse = yield nodeType.trigger.call(triggerFunctions);
                ...
                triggerResponse.manualTriggerResponse = new Promise((resolve, reject) => {
                    triggerFunctions.emit = ((resolveEmit) => (data, responsePromise, donePromise) => {
                        ...
                        if (donePromise) {
                            (_a = additionalData.hooks.hookFunctions.workflowExecuteAfter) === null || _a === void 0 ? void 0 : _a.unshift((runData) => __awaiter(this, void 0, void 0, function* () {
     ...
     * @memberof Workflow
     */
    runWebhook(webhookData, node, additionalData, nodeExecuteFunctions, mode) {
        return __awaiter(this, void 0, void 0, function* () {
            const nodeType = this.nodeTypes.getByNameAndVersion(node.type, node.typeVersion);
            if (nodeType === undefined) {
     ...
     * @memberof Workflow
     */
    runNode(executionData, runExecutionData, runIndex, additionalData, nodeExecuteFunctions, mode) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (nodeType.executeSingle) {
                ...
                let promiseResults;
                try {
                    promiseResults = yield Promise.all(returnPromises);
                }
                catch (error) {
                ...
                return { data: yield nodeType.execute.call(thisArgs) };
            }
                ...
                if (mode === 'manual') {
                    ...
                    return { data: yield nodeType.poll.call(thisArgs) };
                }
                ...
                if (mode === 'manual') {
                    ...
                    const triggerResponse = yield this.runTrigger(node, nodeExecuteFunctions.getExecuteTriggerFunctions, additionalData, mode, 'manual');
                    ...
                    if (triggerResponse.manualTriggerFunction !== undefined) {
                        ...
                        yield triggerResponse.manualTriggerFunction();
                    }
                    const response = yield triggerResponse.manualTriggerResponse;
                    let closeFunction;
                ...
                return {
                    data: yield routingNode.runNode(inputData, runIndex, nodeType, executionData, nodeExecuteFunctions),
                };
            }
            return { data: null };
        });
