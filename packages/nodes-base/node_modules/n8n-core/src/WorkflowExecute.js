...
class WorkflowExecute {
    ...
    processRunExecutionData(workflow) {
        ...
        return new p_cancelable_1.default((resolve, reject, onCancel) => __awaiter(this, void 0, void 0, function* () {
            ...
            const returnPromise = (() => __awaiter(this, void 0, void 0, function* () {
                var _a;
                try {
                ...
                executionLoop: while (this.runExecutionData.executionData.nodeExecutionStack.length !== 0) {
                    ...
                    for (let tryIndex = 0; tryIndex < maxTries; tryIndex++) {
                        ...
                        try {
                            ...
                            const runNodeData = yield workflow.runNode(executionData, this.runExecutionData, runIndex, this.additionalData, _1.NodeExecuteFunctions, this.mode);
    ...
    processSuccessExecution(startedAt, workflow, executionError, closeFunction) {
        return __awaiter(this, void 0, void 0, function* () {
            const fullRunData = this.getFullRunData(startedAt);
            if (executionError !== undefined) {
