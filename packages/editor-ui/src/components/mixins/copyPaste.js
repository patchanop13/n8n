...
exports.copyPaste = vue_1.default.extend({
    data() {
        return {
    ...
    mounted() {
        ...
        let userInput = '';
        const hiddenInputListener = (text) => { };
        ...
        this.onPaste = (0, lodash_1.debounce)((e) => {
            const event = 'paste';
            ...
            for (let index = 0; index < path.length; index++) {
                if (path[index].className && typeof path[index].className === 'string' && (path[index].className.includes('el-message-box') || path[index].className.includes('ignore-key-press'))) {
                    return;
                }
            }
