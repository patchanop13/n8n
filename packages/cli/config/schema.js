...
exports.schema = {
    ...
    logs: {
        ...
        file: {
            ...
            location: {
                ...
                format: String,
                default: path_1.default.join(core.UserSettings.getUserN8nFolderPath(), 'logs/n8n.log'),
    ...
    binaryDataManager: {
        ...
        localStoragePath: {
            format: String,
            default: path_1.default.join(core.UserSettings.getUserN8nFolderPath(), 'binaryData'),
