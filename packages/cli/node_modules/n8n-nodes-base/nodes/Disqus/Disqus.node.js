                ...
                try {
                    ...
                    if (resource === 'forum') {
                        if (operation === 'get') {
                            ...
                            try {
                                const responseData = yield GenericFunctions_1.disqusApiRequest.call(this, requestMethod, qs, endpoint);
                            ...
                            try {
                                let responseData = {};
                                if (returnAll) {
                                    responseData.response = yield GenericFunctions_1.disqusApiRequestAllItems.call(this, requestMethod, qs, endpoint);
                                }
                                else {
                                    const limit = this.getNodeParameter('limit', i);
                                    qs.limit = limit;
                                    responseData = yield GenericFunctions_1.disqusApiRequest.call(this, requestMethod, qs, endpoint);
                                }
