                ...
                try {
                    if (resource === 'company') {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'POST', '/companies', body);
                        }
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'DELETE', `/companies/${companyId}`);
                        }
                            ...
                            const companyId = this.getNodeParameter('companyId', i);
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'GET', `/companies/${companyId}`);
                        }
                            ...
                            responseData = yield GenericFunctions_1.handleListing.call(this, 'POST', '/companies/search', body);
                        }
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'PUT', `/companies/${companyId}`, body);
                        }
                    }
                        ...
                        if (operation === 'getAll') {
                            ...
                            // ----------------------------------------
                            responseData = yield GenericFunctions_1.handleListing.call(this, 'GET', '/customer_sources');
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'POST', '/leads', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //               lead: delete
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'DELETE', `/leads/${leadId}`);
                        }
                        else if (operation === 'get') {
                            // ----------------------------------------
                            //                lead: get
                            ...
                            const leadId = this.getNodeParameter('leadId', i);
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'GET', `/leads/${leadId}`);
                        }
                        else if (operation === 'getAll') {
                            // ----------------------------------------
                            //               lead: getAll
                            ...
                            responseData = yield GenericFunctions_1.handleListing.call(this, 'POST', '/leads/search', body);
                        }
                        else if (operation === 'update') {
                            // ----------------------------------------
                            //               lead: update
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'PUT', `/leads/${leadId}`, body);
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'POST', '/opportunities', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //           opportunity: delete
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'DELETE', `/opportunities/${opportunityId}`);
                        }
                        else if (operation === 'get') {
                            // ----------------------------------------
                            //             opportunity: get
                            ...
                            const opportunityId = this.getNodeParameter('opportunityId', i);
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'GET', `/opportunities/${opportunityId}`);
                        }
                        else if (operation === 'getAll') {
                            // ----------------------------------------
                            //           opportunity: getAll
                            ...
                            responseData = yield GenericFunctions_1.handleListing.call(this, 'POST', '/opportunities/search', body);
                        }
                        else if (operation === 'update') {
                            // ----------------------------------------
                            //           opportunity: update
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'PUT', `/opportunities/${opportunityId}`, body);
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'POST', '/people', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //              person: delete
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'DELETE', `/people/${personId}`);
                        }
                        else if (operation === 'get') {
                            // ----------------------------------------
                            //               person: get
                            ...
                            const personId = this.getNodeParameter('personId', i);
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'GET', `/people/${personId}`);
                        }
                        else if (operation === 'getAll') {
                            // ----------------------------------------
                            //              person: getAll
                            ...
                            responseData = yield GenericFunctions_1.handleListing.call(this, 'POST', '/people/search', body);
                        }
                        else if (operation === 'update') {
                            // ----------------------------------------
                            //              person: update
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'PUT', `/people/${personId}`, body);
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'POST', '/projects', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //             project: delete
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'DELETE', `/projects/${projectId}`);
                        }
                        else if (operation === 'get') {
                            // ----------------------------------------
                            //               project: get
                            ...
                            const projectId = this.getNodeParameter('projectId', i);
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'GET', `/projects/${projectId}`);
                        }
                        else if (operation === 'getAll') {
                            // ----------------------------------------
                            //             project: getAll
                            ...
                            responseData = yield GenericFunctions_1.handleListing.call(this, 'POST', '/projects/search', body);
                        }
                        else if (operation === 'update') {
                            // ----------------------------------------
                            //             project: update
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'PUT', `/projects/${projectId}`, body);
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'POST', '/tasks', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //               task: delete
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'DELETE', `/tasks/${taskId}`);
                        }
                        else if (operation === 'get') {
                            // ----------------------------------------
                            //                task: get
                            ...
                            const taskId = this.getNodeParameter('taskId', i);
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'GET', `/tasks/${taskId}`);
                        }
                        else if (operation === 'getAll') {
                            // ----------------------------------------
                            //               task: getAll
                            ...
                            responseData = yield GenericFunctions_1.handleListing.call(this, 'POST', '/tasks/search', body);
                        }
                        else if (operation === 'update') {
                            // ----------------------------------------
                            //               task: update
                            ...
                            responseData = yield GenericFunctions_1.copperApiRequest.call(this, 'PUT', `/tasks/${taskId}`, body);
                        }
                    }
                        ...
                        if (operation === 'getAll') {
                            ...
                            //              user: getAll
                            // ----------------------------------------
                            responseData = yield GenericFunctions_1.handleListing.call(this, 'POST', '/users/search');
                        }
                    }
                }
                catch (error) {
