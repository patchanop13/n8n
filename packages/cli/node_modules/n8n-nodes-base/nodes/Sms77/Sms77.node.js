                    ...
                    if (resource === 'sms') {
                        if (operation === 'send') {
                            ...
                            const body = Object.assign({ from,
                                to,
                                text }, options);
                            responseData = yield GenericFunctions_1.sms77ApiRequest.call(this, 'POST', '/sms', body);
                        }
                    }
                    if (resource === 'voice') {
                        if (operation === 'send') {
                            ...
                            const body = Object.assign({ to,
                                text }, options);
                            responseData = yield GenericFunctions_1.sms77ApiRequest.call(this, 'POST', '/voice', body);
                        }
                    }
