            ...
            loadOptions: {
                getSounds() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const { sounds } = yield GenericFunctions_1.pushoverApiRequest.call(this, 'GET', '/sounds.json', {});
                        const returnData = [];
                ...
                try {
                    if (resource === 'message') {
                        if (operation === 'push') {
                            ...
                            responseData = yield GenericFunctions_1.pushoverApiRequest.call(this, 'POST', `/messages.json`, body);
                        }
                    }
                }
                catch (error) {
