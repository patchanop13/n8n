            ...
            loadOptions: {
                ...
                getLeadStatuses() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const statuses = yield GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                ...
                getUsers() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const users = yield GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                ...
                getCaseOwners() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const queues = yield GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qsQueues);
                        ...
                        const users = yield GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qsUsers);
                ...
                getLeadSources() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const { fields } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/lead/describe');
                ...
                getCustomFields() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        // TODO: find a way to filter this object to get just the lead sources instead of the whole object
                        const { fields } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/${resource}/describe`);
                        for (const field of fields) {
                ...
                getRecordTypes() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const types = yield GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                ...
                getAccounts() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const accounts = yield GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                ...
                getCampaigns() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const campaigns = yield GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                ...
                getStages() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        // TODO: find a way to filter this object to get just the lead sources instead of the whole object
                        const { fields } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/opportunity/describe');
                        for (const field of fields) {
                ...
                getAccountTypes() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        // TODO: find a way to filter this object to get just the lead sources instead of the whole object
                        const { fields } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/account/describe');
                        for (const field of fields) {
                            if (field.name === 'Type') {
                                for (const pickValue of field.picklistValues) {
                                    const pickValueName = pickValue.label;
                ...
                getCaseTypes() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        // TODO: find a way to filter this object to get just the lead sources instead of the whole object
                        const { fields } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/case/describe');
                        for (const field of fields) {
                            if (field.name === 'Type') {
                                for (const pickValue of field.picklistValues) {
                                    const pickValueName = pickValue.label;
                ...
                getTaskStatuses() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        // TODO: find a way to filter this object to get just the lead sources instead of the whole object
                        const { fields } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/task/describe');
                        for (const field of fields) {
                            if (field.name === 'Status') {
                                for (const pickValue of field.picklistValues) {
                                    const pickValueName = pickValue.label;
                ...
                getCustomObjects() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        // TODO: find a way to filter this object to get just the lead sources instead of the whole object
                        const { sobjects: objects } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects');
                ...
                getCustomObjectFields() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const { fields } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/${customObject}/describe`);
                        for (const field of fields) {
                            const fieldName = field.label;
                            const fieldId = field.name;
                            returnData.push({
                ...
                getAtachmentFields() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        // TODO: find a way to filter this object to get just the lead sources instead of the whole object
                        const { fields } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/attachment/describe`);
                        for (const field of fields) {
                            const fieldName = field.label;
                            const fieldId = field.name;
                            returnData.push({
                ...
                getUserFields() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        // TODO: find a way to filter this object to get just the lead sources instead of the whole object
                        const { fields } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/user/describe`);
                        for (const field of fields) {
                            const fieldName = field.label;
                            const fieldId = field.name;
                            returnData.push({
                ...
                getContactFields() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        // TODO: find a way to filter this object to get just the lead sources instead of the whole object
                        const { fields } = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/contact/describe`);
                        for (const field of fields) {
                            const fieldName = field.label;
                            const fieldId = field.name;
                            returnData.push({
                ...
                try {
                    if (resource === 'lead') {
                        ...
                        if (operation === 'create' || operation === 'upsert') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, method, endpoint, body);
                        }
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'PATCH', `/sobjects/lead/${leadId}`, body);
                        }
                        //https://developer.salesforce.com/docs/api-explorer/sobject/Lead/get-lead-id
                        if (operation === 'get') {
                            const leadId = this.getNodeParameter('leadId', i);
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/lead/${leadId}`);
                        }
                        ...
                        if (operation === 'getAll') {
                            ...
                            try {
                                if (returnAll) {
                                    ...
                                    responseData = yield GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                                }
                                else {
                        ...
                        if (operation === 'delete') {
                            const leadId = this.getNodeParameter('leadId', i);
                            try {
                                responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'DELETE', `/sobjects/lead/${leadId}`);
                            }
                            catch (error) {
                                throw new n8n_workflow_1.NodeApiError(this.getNode(), error);
                            }
                        ...
                        if (operation === 'getSummary') {
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/lead');
                        }
                        ...
                        if (operation === 'addToCampaign') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'POST', '/sobjects/CampaignMember', body);
                        }
                        ...
                        if (operation === 'addNote') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'POST', '/sobjects/note', body);
                        }
                    }
                    if (resource === 'contact') {
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'PATCH', `/sobjects/contact/${contactId}`, body);
                        }
                        //https://developer.salesforce.com/docs/api-explorer/sobject/Contact/get-contact-id
                        if (operation === 'get') {
                            const contactId = this.getNodeParameter('contactId', i);
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/contact/${contactId}`);
                        }
                        //https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_query.htm
                        if (operation === 'getAll') {
                            const returnAll = this.getNodeParameter('returnAll', i);
                        ...
                        if (operation === 'delete') {
                            const contactId = this.getNodeParameter('contactId', i);
                            try {
                                responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'DELETE', `/sobjects/contact/${contactId}`);
                            }
                            catch (error) {
                                throw new n8n_workflow_1.NodeApiError(this.getNode(), error);
                            }
                        ...
                        if (operation === 'getSummary') {
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/contact');
                        }
                        //https://developer.salesforce.com/docs/api-explorer/sobject/CampaignMember
                        if (operation === 'addToCampaign') {
                            const contactId = this.getNodeParameter('contactId', i);
                    ...
                    if (resource === 'customObject') {
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'PATCH', `/sobjects/${customObject}/${recordId}`, body);
                        }
                        if (operation === 'get') {
                            const customObject = this.getNodeParameter('customObject', i);
                            const recordId = this.getNodeParameter('recordId', i);
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/${customObject}/${recordId}`);
                        }
                        if (operation === 'getAll') {
                            const customObject = this.getNodeParameter('customObject', i);
                            const returnAll = this.getNodeParameter('returnAll', i);
                        ...
                        if (operation === 'delete') {
                            ...
                            const recordId = this.getNodeParameter('recordId', i);
                            try {
                                responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'DELETE', `/sobjects/${customObject}/${recordId}`);
                            }
                            catch (error) {
                                throw new n8n_workflow_1.NodeApiError(this.getNode(), error);
                            }
                    ...
                    if (resource === 'document') {
                        ...
                        if (operation === 'upload') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'POST', '/sobjects/ContentVersion', {}, {}, undefined, { formData: data });
                        }
                    }
                    if (resource === 'opportunity') {
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'PATCH', `/sobjects/opportunity/${opportunityId}`, body);
                        }
                        //https://developer.salesforce.com/docs/api-explorer/sobject/Opportunity/get-opportunity-id
                        if (operation === 'get') {
                            const opportunityId = this.getNodeParameter('opportunityId', i);
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/opportunity/${opportunityId}`);
                        }
                        //https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_query.htm
                        if (operation === 'getAll') {
                            const returnAll = this.getNodeParameter('returnAll', i);
                        ...
                        if (operation === 'delete') {
                            const opportunityId = this.getNodeParameter('opportunityId', i);
                            try {
                                responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'DELETE', `/sobjects/opportunity/${opportunityId}`);
                            }
                            catch (error) {
                                throw new n8n_workflow_1.NodeApiError(this.getNode(), error);
                            }
                        ...
                        if (operation === 'getSummary') {
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/opportunity');
                        }
                        //https://developer.salesforce.com/docs/api-explorer/sobject/Note/post-note
                        if (operation === 'addNote') {
                            const opportunityId = this.getNodeParameter('opportunityId', i);
                    ...
                    if (resource === 'account') {
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'PATCH', `/sobjects/account/${accountId}`, body);
                        }
                        //https://developer.salesforce.com/docs/api-explorer/sobject/Account/get-account-id
                        if (operation === 'get') {
                            const accountId = this.getNodeParameter('accountId', i);
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/account/${accountId}`);
                        }
                        //https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_query.htm
                        if (operation === 'getAll') {
                            const returnAll = this.getNodeParameter('returnAll', i);
                        ...
                        if (operation === 'delete') {
                            const accountId = this.getNodeParameter('accountId', i);
                            try {
                                responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'DELETE', `/sobjects/account/${accountId}`);
                            }
                            catch (error) {
                                throw new n8n_workflow_1.NodeApiError(this.getNode(), error);
                            }
                        ...
                        if (operation === 'getSummary') {
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/account');
                        }
                        //https://developer.salesforce.com/docs/api-explorer/sobject/Note/post-note
                        if (operation === 'addNote') {
                            const accountId = this.getNodeParameter('accountId', i);
                    ...
                    if (resource === 'case') {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'POST', '/sobjects/case', body);
                        }
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'PATCH', `/sobjects/case/${caseId}`, body);
                        }
                        //https://developer.salesforce.com/docs/api-explorer/sobject/Case/get-case-id
                        if (operation === 'get') {
                            const caseId = this.getNodeParameter('caseId', i);
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/case/${caseId}`);
                        }
                        //https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_query.htm
                        if (operation === 'getAll') {
                            const returnAll = this.getNodeParameter('returnAll', i);
                        ...
                        if (operation === 'delete') {
                            const caseId = this.getNodeParameter('caseId', i);
                            try {
                                responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'DELETE', `/sobjects/case/${caseId}`);
                            }
                            catch (error) {
                                throw new n8n_workflow_1.NodeApiError(this.getNode(), error);
                            }
                        ...
                        if (operation === 'getSummary') {
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/case');
                        }
                        ...
                        if (operation === 'addComment') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'POST', '/sobjects/casecomment', body);
                        }
                    }
                    if (resource === 'task') {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'POST', '/sobjects/task', body);
                        }
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'PATCH', `/sobjects/task/${taskId}`, body);
                        }
                        //https://developer.salesforce.com/docs/api-explorer/sobject/Task/get-task-id
                        if (operation === 'get') {
                            const taskId = this.getNodeParameter('taskId', i);
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/task/${taskId}`);
                        }
                        //https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_query.htm
                        if (operation === 'getAll') {
                            const returnAll = this.getNodeParameter('returnAll', i);
                        ...
                        if (operation === 'delete') {
                            const taskId = this.getNodeParameter('taskId', i);
                            try {
                                responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'DELETE', `/sobjects/task/${taskId}`);
                            }
                            catch (error) {
                                throw new n8n_workflow_1.NodeApiError(this.getNode(), error);
                            }
                        ...
                        if (operation === 'getSummary') {
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/task');
                        }
                    }
                    if (resource === 'attachment') {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'POST', '/sobjects/attachment', body);
                        }
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'PATCH', `/sobjects/attachment/${attachmentId}`, body);
                        }
                        //https://developer.salesforce.com/docs/api-explorer/sobject/Attachment/get-attachment-id
                        if (operation === 'get') {
                            const attachmentId = this.getNodeParameter('attachmentId', i);
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/attachment/${attachmentId}`);
                        }
                        //https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_query.htm
                        if (operation === 'getAll') {
                            const returnAll = this.getNodeParameter('returnAll', i);
                        ...
                        if (operation === 'delete') {
                            const attachmentId = this.getNodeParameter('attachmentId', i);
                            try {
                                responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'DELETE', `/sobjects/attachment/${attachmentId}`);
                            }
                            catch (error) {
                                throw new n8n_workflow_1.NodeApiError(this.getNode(), error);
                            }
                        ...
                        //https://developer.salesforce.com/docs/api-explorer/sobject/Attachment/get-attachment-id
                        if (operation === 'getSummary') {
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/sobjects/attachment');
                        }
                    }
                    if (resource === 'user') {
                        ...
                        if (operation === 'get') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/sobjects/user/${userId}`);
                        }
                        //https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_query.htm
                        if (operation === 'getAll') {
                            const returnAll = this.getNodeParameter('returnAll', i);
                    ...
                    if (resource === 'flow') {
                        ...
                        if (operation === 'invoke') {
                            ...
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'POST', `/actions/custom/flow/${apiName}`, body);
                        }
                        //https://developer.salesforce.com/docs/atlas.en-us.api_action.meta/api_action/actions_obj_flow.htm
                        if (operation === 'getAll') {
                            const returnAll = this.getNodeParameter('returnAll', i);
                            responseData = yield GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/actions/custom/flow');
