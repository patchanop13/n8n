            ...
            for (let i = 0; i < items.length; i++) {
                try {
                    ...
                    if (binaryData === true) {
                        ...
                        body.disable_notification = ((_a = body.disable_notification) === null || _a === void 0 ? void 0 : _a.toString()) || 'false';
                        ...
                        responseData = yield GenericFunctions_1.apiRequest.call(this, requestMethod, endpoint, {}, qs, { formData });
                    }
                    else {
                    ...
                    if (resource === 'file' && operation === 'get') {
                        if (this.getNodeParameter('download', i, false) === true) {
                            ...
                            const file = yield GenericFunctions_1.apiRequest.call(this, 'GET', '', {}, {}, { json: false, encoding: null, uri: `https://api.telegram.org/file/bot${credentials.accessToken}/${filePath}`, resolveWithFullResponse: true });
                            const fileName = filePath.split('/').pop();
                            const binaryData = yield this.helpers.prepareBinaryData(Buffer.from(file.body), fileName);
                            returnData.push({
                                json: responseData,
                                binary: {
                                    data: binaryData,
