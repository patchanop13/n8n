...
exports.messagePostDescription = [
    {
        ...
        description: 'The ID of the channel to post to. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/nodes/expressions.html#expressions">expression</a>.',
    },
    {
        displayName: 'Message',
        name: 'message',
