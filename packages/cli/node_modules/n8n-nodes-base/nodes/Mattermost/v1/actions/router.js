        ...
        for (let i = 0; i < items.length; i++) {
            ...
            try {
                if (mattermost.resource === 'channel') {
                    operationResult.push(...yield channel[mattermost.operation].execute.call(this, i));
                }
                else if (mattermost.resource === 'message') {
                    operationResult.push(...yield message[mattermost.operation].execute.call(this, i));
                }
                else if (mattermost.resource === 'reaction') {
                    operationResult.push(...yield reaction[mattermost.operation].execute.call(this, i));
                }
                else if (mattermost.resource === 'user') {
                    operationResult.push(...yield user[mattermost.operation].execute.call(this, i));
                }
            }
            catch (err) {
