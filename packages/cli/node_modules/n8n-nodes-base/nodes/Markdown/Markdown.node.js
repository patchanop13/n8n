            ...
            for (let i = 0; i < length; i++) {
                try {
                    if (mode === 'htmlToMarkdown') {
                        ...
                        options.textReplace = !(0, lodash_1.isEmpty)(textReplaceOption)
                        ...
                        options.lineStartEscape = !(0, lodash_1.isEmpty)(lineStartEscapeOption)
                        ...
                        options.globalEscape = !(0, lodash_1.isEmpty)(globalEscapeOption)
                            ? [globalEscapeOption.pattern, globalEscapeOption.replacement]
                            : undefined;
                        options.ignore = options.ignore
                            ? options.ignore.split(',').map(element => element.trim()) : undefined;
                        options.blockElements = options.blockElements
                            ? options.blockElements.split(',').map(element => element.trim()) : undefined;
                        ...
                        (0, lodash_1.set)(newItem, destinationKey, markdownFromHTML);
                    ...
                    if (mode === 'markdownToHtml') {
                        ...
                        const newItem = JSON.parse(JSON.stringify(items[i].json));
                        (0, lodash_1.set)(newItem, destinationKey, htmlFromMarkdown);
                        returnData.push(newItem);
                    }
                }
                catch (error) {
