            ...
            default: {
                checkExists() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        let { reporting_webhooks: webhooks } = yield GenericFunctions_1.customerIoApiRequest.call(this, 'GET', endpoint, {}, 'beta');
                        if (webhooks === null) {
                            webhooks = [];
                        }
                ...
                create() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        webhook = yield GenericFunctions_1.customerIoApiRequest.call(this, 'POST', endpoint, body, 'beta');
                        const webhookData = this.getWorkflowStaticData('node');
                        webhookData.webhookId = webhook.id;
                        return true;
                    });
                ...
                delete() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (webhookData.webhookId !== undefined) {
                            ...
                            try {
                                yield GenericFunctions_1.customerIoApiRequest.call(this, 'DELETE', endpoint, {}, 'beta');
                            }
                            catch (error) {
                                return false;
                            }
