            ...
            default: {
                checkExists() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            yield GenericFunctions_1.githubApiRequest.call(this, 'GET', endpoint, {});
                        }
                        catch (error) {
                ...
                create() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        let responseData;
                        try {
                            responseData = yield GenericFunctions_1.githubApiRequest.call(this, 'POST', endpoint, body);
                        }
                        catch (error) {
                            if (error.httpCode === '422') {
                                // Webhook exists already
                                // Get the data of the already registered webhook
                                responseData = yield GenericFunctions_1.githubApiRequest.call(this, 'GET', endpoint, body);
                ...
                delete() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (webhookData.webhookId !== undefined) {
                            ...
                            const body = {};
                            try {
                                yield GenericFunctions_1.githubApiRequest.call(this, 'DELETE', endpoint, body);
                            }
                            catch (error) {
                                return false;
                            }
