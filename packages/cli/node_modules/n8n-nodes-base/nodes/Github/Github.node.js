        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < items.length; i++) {
                try {
                    ...
                    if (resource === 'file') {
                        if (['create', 'edit'].includes(operation)) {
                            ...
                            if (operation === 'edit') {
                                ...
                                body.sha = yield GenericFunctions_1.getFileSha.call(this, owner, repository, filePath, body.branch);
                            }
                    ...
                    if (returnAll === true) {
                        responseData = yield GenericFunctions_1.githubApiRequestAllItems.call(this, requestMethod, endpoint, body, qs);
                    }
                    else {
                        responseData = yield GenericFunctions_1.githubApiRequest.call(this, requestMethod, endpoint, body, qs);
                    }
                    if (fullOperation === 'file:get') {
                        ...
                        if (asBinaryProperty === true) {
                            ...
                            newItem.binary[binaryPropertyName] = yield this.helpers.prepareBinaryData(Buffer.from(responseData.content, 'base64'), responseData.path);
                            items[i] = newItem;
