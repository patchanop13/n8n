            ...
            loadOptions: {
                ...
                getGoals() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const returnData = [];
                        const goals = yield GenericFunctions_1.beeminderApiRequest.call(this, 'GET', endpoint);
                ...
                try {
                    if (resource === 'datapoint') {
                        ...
                        if (operation === 'create') {
                            ...
                            results = yield Beeminder_node_functions_1.createDatapoint.call(this, data);
                        }
                            ...
                            results = yield Beeminder_node_functions_1.getAllDatapoints.call(this, data);
                        }
                            ...
                            results = yield Beeminder_node_functions_1.updateDatapoint.call(this, data);
                        }
                            ...
                            results = yield Beeminder_node_functions_1.deleteDatapoint.call(this, data);
                        }
                    }
                }
                catch (error) {
