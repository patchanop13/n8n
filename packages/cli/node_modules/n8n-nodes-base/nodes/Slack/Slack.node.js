            ...
            loadOptions: {
                ...
                getUsers() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const users = yield GenericFunctions_1.slackApiRequestAllItems.call(this, 'members', 'GET', '/users.list');
                ...
                getChannels() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const channels = yield GenericFunctions_1.slackApiRequestAllItems.call(this, 'channels', 'GET', '/conversations.list', {}, qs);
                ...
                getTeamFields() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const { profile: { fields } } = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/team.profile.get');
                ...
                try {
                    ...
                    if (resource === 'channel') {
                        ...
                        if (operation === 'archive') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.archive', body, qs);
                        }
                        ...
                        if (operation === 'close') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.close', body, qs);
                        }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.create', body, qs);
                        ...
                        if (operation === 'kick') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.kick', body, qs);
                        }
                        ...
                        if (operation === 'join') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.join', body, qs);
                            responseData = responseData.channel;
                        }
                        ...
                        if (operation === 'get') {
                            const channel = this.getNodeParameter('channelId', i);
                            qs.channel = channel;
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.info', {}, qs);
                            responseData = responseData.channel;
                        }
                        ...
                        if (operation === 'getAll') {
                            ...
                            if (returnAll === true) {
                                responseData = yield GenericFunctions_1.slackApiRequestAllItems.call(this, 'channels', 'GET', '/conversations.list', {}, qs);
                            }
                            else {
                                qs.limit = this.getNodeParameter('limit', i);
                                responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/conversations.list', {}, qs);
                        ...
                        if (operation === 'history') {
                            ...
                            if (returnAll === true) {
                                responseData = yield GenericFunctions_1.slackApiRequestAllItems.call(this, 'messages', 'GET', '/conversations.history', {}, qs);
                            }
                            else {
                                qs.limit = this.getNodeParameter('limit', i);
                                responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/conversations.history', {}, qs);
                        ...
                        if (operation === 'invite') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.invite', body, qs);
                            responseData = responseData.channel;
                        }
                        ...
                        if (operation === 'leave') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.leave', body, qs);
                        }
                        ...
                        if (operation === 'member') {
                            ...
                            if (returnAll) {
                                responseData = yield GenericFunctions_1.slackApiRequestAllItems.call(this, 'members', 'GET', '/conversations.members', {}, qs);
                                responseData = responseData.map((member) => ({ member }));
                            }
                            else {
                                qs.limit = this.getNodeParameter('limit', i);
                                responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/conversations.members', {}, qs);
                                responseData = responseData.members.map((member) => ({ member }));
                            }
                            if (resolveData) {
                                const data = [];
                                for (const { member } of responseData) {
                                    const { user } = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/users.info', {}, { user: member });
                                    data.push(user);
                                }
                                responseData = data;
                            }
                        ...
                        if (operation === 'open') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.open', body, qs);
                            responseData = responseData.channel;
                        }
                        ...
                        if (operation === 'rename') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.rename', body, qs);
                            responseData = responseData.channel;
                        }
                        ...
                        if (operation === 'replies') {
                            ...
                            if (returnAll === true) {
                                responseData = yield GenericFunctions_1.slackApiRequestAllItems.call(this, 'messages', 'GET', '/conversations.replies', {}, qs);
                            }
                            else {
                                qs.limit = this.getNodeParameter('limit', i);
                                responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/conversations.replies', {}, qs);
                                responseData = responseData.messages;
                            }
                        }
                        ...
                        if (operation === 'setPurpose') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.setPurpose', body, qs);
                            responseData = responseData.channel;
                        }
                        ...
                        if (operation === 'setTopic') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.setTopic', body, qs);
                            responseData = responseData.channel;
                        }
                        ...
                        if (operation === 'unarchive') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/conversations.unarchive', body, qs);
                        }
                    }
                    if (resource === 'message') {
                        ...
                        if (['post', 'postEphemeral'].includes(operation)) {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', `/chat.${action}`, body, qs);
                        }
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/chat.update', body, qs);
                        }
                        ...
                        if (operation === 'delete') {
                            ...
                            // Add all the other options to the request
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/chat.delete', body, qs);
                        }
                        ...
                        if (operation === 'getPermalink') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/chat.getPermalink', {}, qs);
                        }
                    }
                    if (resource === 'reaction') {
                        ...
                        if (operation === 'add') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/reactions.add', body, qs);
                        }
                        ...
                        if (operation === 'remove') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/reactions.remove', body, qs);
                        }
                        //https://api.slack.com/methods/reactions.get
                        if (operation === 'get') {
                            qs.channel = channel;
                            qs.timestamp = timestamp;
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/reactions.get', {}, qs);
                        }
                    }
                    if (resource === 'star') {
                        ...
                        if (operation === 'add') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/stars.add', body, qs);
                        }
                        ...
                        if (operation === 'delete') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/stars.remove', body, qs);
                        }
                        //https://api.slack.com/methods/stars.list
                        if (operation === 'getAll') {
                            const returnAll = this.getNodeParameter('returnAll', i);
                            if (returnAll === true) {
                                responseData = yield GenericFunctions_1.slackApiRequestAllItems.call(this, 'items', 'GET', '/stars.list', {}, qs);
                            }
                            else {
                                qs.limit = this.getNodeParameter('limit', i);
                                responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/stars.list', {}, qs);
                    ...
                    if (resource === 'file') {
                        ...
                        if (operation === 'upload') {
                            ...
                            if (binaryData) {
                                ...
                                responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/files.upload', {}, qs, { 'Content-Type': 'multipart/form-data' }, { formData: body });
                                responseData = responseData.file;
                            }
                            else {
                                const fileContent = this.getNodeParameter('fileContent', i);
                                body.content = fileContent;
                                responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/files.upload', body, qs, { 'Content-Type': 'application/x-www-form-urlencoded' }, { form: body });
                                responseData = responseData.file;
                            }
                        }
                        ...
                        if (operation === 'getAll') {
                            ...
                            if (returnAll === true) {
                                responseData = yield GenericFunctions_1.slackApiRequestAllItems.call(this, 'files', 'GET', '/files.list', {}, qs);
                            }
                            else {
                                qs.count = this.getNodeParameter('limit', i);
                                responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/files.list', {}, qs);
                        ...
                        if (operation === 'get') {
                            ...
                            qs.file = fileId;
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/files.info', {}, qs);
                            responseData = responseData.file;
                        }
                    }
                    if (resource === 'user') {
                        ...
                        if (operation === 'info') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/users.info', {}, qs);
                            responseData = responseData.user;
                        }
                        //https://api.slack.com/methods/users.getPresence
                        if (operation === 'getPresence') {
                            qs.user = this.getNodeParameter('user', i);
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/users.getPresence', {}, qs);
                        }
                    }
                    if (resource === 'userGroup') {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/usergroups.create', body, qs);
                        ...
                        if (operation === 'enable') {
                            ...
                            Object.assign(body, additionalFields);
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/usergroups.enable', body, qs);
                            responseData = responseData.usergroup;
                        }
                        ...
                        if (operation === 'disable') {
                            ...
                            Object.assign(body, additionalFields);
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/usergroups.disable', body, qs);
                            responseData = responseData.usergroup;
                        }
                        ...
                        if (operation === 'getAll') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'GET', '/usergroups.list', {}, qs);
                        ...
                        if (operation === 'update') {
                            ...
                            Object.assign(body, updateFields);
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/usergroups.update', body, qs);
                            responseData = responseData.usergroup;
                        }
                    }
                    if (resource === 'userProfile') {
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/users.profile.set', { profile: body }, qs);
                        ...
                        if (operation === 'get') {
                            ...
                            const qs = {};
                            Object.assign(qs, additionalFields);
                            responseData = yield GenericFunctions_1.slackApiRequest.call(this, 'POST', '/users.profile.get', undefined, qs);
                            responseData = responseData.profile;
                        }
                    }
