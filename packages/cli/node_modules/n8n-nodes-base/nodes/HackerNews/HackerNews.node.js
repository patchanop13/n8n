        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < items.length; i++) {
                try {
                    ...
                    let responseData;
                    if (returnAll === true) {
                        responseData = yield GenericFunctions_1.hackerNewsApiRequestAllItems.call(this, 'GET', endpoint, qs);
                    }
                    else {
                        responseData = yield GenericFunctions_1.hackerNewsApiRequest.call(this, 'GET', endpoint, qs);
