        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (mode === 'queue') {
                    ...
                    channel = yield GenericFunctions_1.rabbitmqConnectQueue.call(this, queue, options);
                    ...
                    // @ts-ignore
                    const promisesResponses = yield Promise.allSettled(queuePromises);
                    // @ts-ignore
                    ...
                    options = this.getNodeParameter('options', 0, {});
                    channel = yield GenericFunctions_1.rabbitmqConnectExchange.call(this, exchange, type, options);
                    const sendInputData = this.getNodeParameter('sendInputData', 0);
                    let message;
                    ...
                    // @ts-ignore
                    const promisesResponses = yield Promise.allSettled(exchangePromises);
                    // @ts-ignore
                    promisesResponses.forEach((response) => {
                        if (response.status !== 'fulfilled') {
                            if (this.continueOnFail() !== true) {
