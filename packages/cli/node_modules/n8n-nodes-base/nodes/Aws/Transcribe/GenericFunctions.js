...
function awsApiRequestRESTAllItems(propertyName, service, method, path, body, query = {}, headers = {}, option = {}, region) {
    return __awaiter(this, void 0, void 0, function* () {
        const returnData = [];
        let responseData;
        const propertyNameArray = propertyName.split('.');
        do {
            responseData = yield awsApiRequestREST.call(this, service, method, path, body, query);
