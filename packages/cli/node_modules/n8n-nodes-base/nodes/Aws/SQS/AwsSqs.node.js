                ...
                getQueues() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            ...
                            data = yield GenericFunctions_1.awsApiRequestSOAP.call(this, 'sqs', 'GET', `?${params.join('&')}`);
                        }
                        catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < items.length; i++) {
                try {
                    ...
                    const params = [
                        'Version=2012-11-05',
                        `Action=${(0, change_case_1.pascalCase)(operation)}`,
                    ];
                    ...
                    let responseData;
                    try {
                        responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, 'sqs', 'GET', `${queuePath}?${params.join('&')}`);
                    }
                    catch (error) {
                        throw new n8n_workflow_1.NodeApiError(this.getNode(), error);
                    }
