                ...
                try {
                    if (resource === 'bucket') {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${name}.s3`, 'PUT', '', data, qs, headers);
                            returnData.push({ success: true });
                        }
                        // https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteBucket.html
                        if (operation === 'delete') {
                            const name = this.getNodeParameter('name', i);
                            responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${name}.s3`, 'DELETE', '', '', {}, headers);
                            returnData.push({ success: true });
                        }
                        ...
                        if (operation === 'getAll') {
                            ...
                            if (returnAll) {
                                responseData = yield GenericFunctions_1.awsApiRequestSOAPAllItems.call(this, 'ListAllMyBucketsResult.Buckets.Bucket', 's3', 'GET', '');
                            }
                            else {
                                qs.limit = this.getNodeParameter('limit', 0);
                                responseData = yield GenericFunctions_1.awsApiRequestSOAPAllItems.call(this, 'ListAllMyBucketsResult.Buckets.Bucket', 's3', 'GET', '', '', qs);
                        ...
                        if (operation === 'search') {
                            ...
                            qs['list-type'] = 2;
                            responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'GET', '', '', { location: '' });
                            const region = responseData.LocationConstraint._;
                            if (returnAll) {
                                responseData = yield GenericFunctions_1.awsApiRequestSOAPAllItems.call(this, 'ListBucketResult.Contents', `${bucketName}.s3`, 'GET', '', '', qs, {}, {}, region);
                            }
                            else {
                                qs['max-keys'] = this.getNodeParameter('limit', 0);
                                responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'GET', '', '', qs, {}, {}, region);
                    ...
                    if (resource === 'folder') {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'GET', '', '', { location: '' });
                            const region = responseData.LocationConstraint._;
                            responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'PUT', path, '', qs, headers, {}, region);
                            returnData.push({ success: true });
                        }
                        ...
                        if (operation === 'delete') {
                            ...
                            responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'GET', '', '', { location: '' });
                            const region = responseData.LocationConstraint._;
                            responseData = yield GenericFunctions_1.awsApiRequestSOAPAllItems.call(this, 'ListBucketResult.Contents', `${bucketName}.s3`, 'GET', '/', '', { 'list-type': 2, prefix: folderKey }, {}, {}, region);
                            // folder empty then just delete it
                            if (responseData.length === 0) {
                                responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'DELETE', `/${folderKey}`, '', qs, {}, {}, region);
                                ...
                                responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'POST', '/', data, { delete: '' }, headers, {}, region);
                    ...
                    if (resource === 'file') {
                        ...
                        if (operation === 'copy') {
                            ...
                            responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'GET', '', '', { location: '' });
                            const region = responseData.LocationConstraint._;
                            responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'PUT', destination, '', qs, headers, {}, region);
                        ...
                        if (operation === 'download') {
                            ...
                            let region = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'GET', '', '', { location: '' });
                            region = region.LocationConstraint._;
                            const response = yield GenericFunctions_1.awsApiRequestREST.call(this, `${bucketName}.s3`, 'GET', `/${fileKey}`, '', qs, {}, { encoding: null, resolveWithFullResponse: true }, region);
                            let mimeType;
                        ...
                        if (operation === 'delete') {
                            ...
                            responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'GET', '', '', { location: '' });
                            const region = responseData.LocationConstraint._;
                            responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'DELETE', `/${fileKey}`, '', qs, {}, {}, region);
                            returnData.push({ success: true });
                        }
                        //https://docs.aws.amazon.com/AmazonS3/latest/API/API_ListObjectsV2.html
                        if (operation === 'getAll') {
                        ...
                        if (operation === 'upload') {
                            ...
                            if (isBinaryData) {
                                ...
                                responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'PUT', `${path}${fileName || binaryData.fileName}`, body, qs, headers, {}, region);
                            }
                            else {
                                ...
                                responseData = yield GenericFunctions_1.awsApiRequestSOAP.call(this, `${bucketName}.s3`, 'PUT', `${path}${fileName}`, body, qs, headers, {}, region);
                            }
                            returnData.push({ success: true });
                        }
                    }
