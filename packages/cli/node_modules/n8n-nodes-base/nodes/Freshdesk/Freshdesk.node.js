            ...
            loadOptions: {
                ...
                getAgents() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const agents = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'GET', '/agents');
                ...
                getGroups() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const groups = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'GET', '/groups');
                ...
                getProducts() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const products = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'GET', '/products');
                ...
                getCompanies() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const companies = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'GET', '/companies');
                ...
                try {
                    if (resource === 'ticket') {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'POST', '/tickets', body);
                        }
                        ...
                        if (operation === 'update') {
                            ...
                            responseData = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'PUT', `/tickets/${ticketId}`, body);
                        }
                        //https://developers.freshdesk.com/api/#view_a_ticket
                        if (operation === 'get') {
                            const ticketId = this.getNodeParameter('ticketId', i);
                            responseData = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'GET', `/tickets/${ticketId}`);
                        }
                        ...
                        if (operation === 'getAll') {
                            ...
                            if (returnAll === true) {
                                responseData = yield GenericFunctions_1.freshdeskApiRequestAllItems.call(this, 'GET', '/tickets', {}, qs);
                            }
                            else {
                                qs.per_page = this.getNodeParameter('limit', i);
                                responseData = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'GET', '/tickets', {}, qs);
                            }
                        }
                        //https://developers.freshdesk.com/api/#delete_a_ticket
                        if (operation === 'delete') {
                            const ticketId = this.getNodeParameter('ticketId', i);
                            responseData = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'DELETE', `/tickets/${ticketId}`);
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'POST', '/contacts', body);
                            //https://developers.freshdesk.com/api/#delete_contact
                        }
                        else if (operation === 'delete') {
                            const contactId = this.getNodeParameter('contactId', i);
                            responseData = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'DELETE', `/contacts/${contactId}`, {});
                        }
                        else if (operation === 'get') {
                            const contactId = this.getNodeParameter('contactId', i);
                            responseData = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'GET', `/contacts/${contactId}`, {});
                            //https://developers.freshdesk.com/api/#list_all_contacts
                        }
                        else if (operation === 'getAll') {
                            const qs = this.getNodeParameter('filters', i, {});
                            responseData = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'GET', '/contacts', {}, qs);
                            ...
                            const body = additionalFields;
                            responseData = yield GenericFunctions_1.freshdeskApiRequest.call(this, 'PUT', `/contacts/${contactId}`, body);
                        }
                    }
