            ...
            loadOptions: {
                getActivityTypes() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', '/activitytypes');
                        return (0, GenericFunctions_1.toOptions)(responseData);
                    });
                },
                getTagsToAdd() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const responseData = yield GenericFunctions_1.monicaCrmApiRequestAllItems.call(this, 'GET', '/tags', {}, {}, { forLoader: true });
                ...
                getContactFieldTypes() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', '/contactfieldtypes');
                        return (0, GenericFunctions_1.toOptions)(responseData);
                    });
                },
                getGenders() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', '/genders');
                        return (0, GenericFunctions_1.toOptions)(responseData);
                    });
                },
            },
                ...
                try {
                    if (resource === 'activity') {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', '/activities', body);
                        }
                            ...
                            yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'DELETE', endpoint);
                            ...
                            const activityId = this.getNodeParameter('activityId', i);
                            const endpoint = `/activities/${activityId}`;
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', endpoint);
                        }
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequestAllItems.call(this, 'GET', endpoint);
                        }
                            ...
                            const activityId = this.getNodeParameter('activityId', i);
                            const { data } = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/activities/${activityId}`);
                            const body = {
                            ...
                            const endpoint = `/activities/${activityId}`;
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'PUT', endpoint, body);
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', '/calls', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //               call: delete
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'DELETE', `/calls/${callId}`);
                            responseData = { success: true };
                        }
                        else if (operation === 'get') {
                            // ----------------------------------------
                            ...
                            const callId = this.getNodeParameter('callId', i);
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/calls/${callId}`);
                        }
                        else if (operation === 'getAll') {
                            // ----------------------------------------
                            //               call: getAll
                            ...
                            const callId = this.getNodeParameter('callId', i);
                            const { data } = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/calls/${callId}`);
                            const body = {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'PUT', `/calls/${callId}`, body);
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', '/contacts', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //             contact: delete
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequestAllItems.call(this, 'GET', '/contacts', {}, qs);
                        }
                        else if (operation === 'update') {
                            // ----------------------------------------
                            //             contact: update
                            // ----------------------------------------
                            const contactId = this.getNodeParameter('contactId', i);
                            const { data } = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/contacts/${contactId}`);
                            const body = {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', '/contactfields', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //           contactField: delete
                        ...
                        if (operation === 'add') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', endpoint, body);
                        }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', '/conversations', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //           conversation: delete
                        ...
                        if (operation === 'add') {
                            ...
                            const { data } = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/conversations/${conversationId}`);
                            const body = {
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', '/journal', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //           journalEntry: delete
                            ...
                            yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'DELETE', `/journal/${journalId}`);
                            responseData = { success: true };
                        }
                        else if (operation === 'get') {
                            // ----------------------------------------
                            ...
                            const journalId = this.getNodeParameter('journalId', i);
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/journal/${journalId}`);
                        }
                        else if (operation === 'getAll') {
                            // ----------------------------------------
                            //           journalEntry: getAll
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequestAllItems.call(this, 'GET', '/journal');
                        }
                        else if (operation === 'update') {
                            // ----------------------------------------
                            //           journalEntry: update
                            ...
                            const journalId = this.getNodeParameter('journalId', i);
                            const { data } = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/journal/${journalId}`);
                            const updateFields = this.getNodeParameter('updateFields', i);
                            const body = {
                                post: data.post,
                                title: data.title,
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'PUT', `/journal/${journalId}`, body);
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', '/notes', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //               note: delete
                            ...
                            yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'DELETE', `/notes/${noteId}`);
                            responseData = { success: true };
                        }
                        else if (operation === 'get') {
                            // ----------------------------------------
                            ...
                            const noteId = this.getNodeParameter('noteId', i);
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/notes/${noteId}`);
                        }
                        else if (operation === 'getAll') {
                            // ----------------------------------------
                            //               note: getAll
                            ...
                            const noteId = this.getNodeParameter('noteId', i);
                            const updateFields = this.getNodeParameter('updateFields', i);
                            const { data } = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/notes/${noteId}`);
                            const body = {
                                body: data.body,
                                contact_id: data.contact.id,
                            };
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'PUT', `/notes/${noteId}`, body);
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', '/reminders', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //             reminder: delete
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequestAllItems.call(this, 'GET', '/reminders');
                        }
                        else if (operation === 'update') {
                            // ----------------------------------------
                            //             reminder: update
                            ...
                            const reminderId = this.getNodeParameter('reminderId', i);
                            const { data } = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/reminders/${reminderId}`);
                            const body = {
                                contact_id: data.contact.id,
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', '/tags', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //               tag: delete
                            ...
                            yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'DELETE', `/tags/${tagId}`);
                            responseData = { success: true };
                        }
                        else if (operation === 'get') {
                            // ----------------------------------------
                            ...
                            const tagId = this.getNodeParameter('tagId', i);
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/tags/${tagId}`);
                        }
                        else if (operation === 'getAll') {
                            // ----------------------------------------
                            //               tag: getAll
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequestAllItems.call(this, 'GET', '/tags');
                        }
                        else if (operation === 'update') {
                            // ----------------------------------------
                            //               tag: update
                            ...
                            const tagId = this.getNodeParameter('tagId', i);
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'PUT', `/tags/${tagId}`, body);
                        }
                    }
                        ...
                        if (operation === 'create') {
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'POST', '/tasks', body);
                        }
                        else if (operation === 'delete') {
                            // ----------------------------------------
                            //               task: delete
                            ...
                            yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'DELETE', `/tasks/${taskId}`);
                            responseData = { success: true };
                        }
                        else if (operation === 'get') {
                            // ----------------------------------------
                            ...
                            const taskId = this.getNodeParameter('taskId', i);
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/tasks/${taskId}`);
                        }
                        else if (operation === 'getAll') {
                            // ----------------------------------------
                            //               task: getAll
                            ...
                            const taskId = this.getNodeParameter('taskId', i);
                            const { data } = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'GET', `/tasks/${taskId}`);
                            const body = {
                                contact_id: data.contact.id,
                                title: data.title,
                            ...
                            responseData = yield GenericFunctions_1.monicaCrmApiRequest.call(this, 'PUT', `/tasks/${taskId}`, body);
                        }
                    }
                }
                catch (error) {
