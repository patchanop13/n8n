...
function magentoApiRequest(method, resource, body = {}, qs = {}, uri, headers = {}, option = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const credentials = yield this.getCredentials('magento2Api');
        let options = {
            method,
            body,
            qs,
        ...
        try {
            ...
            //@ts-ignore
            return yield this.helpers.requestWithAuthentication.call(this, 'magento2Api', options);
        }
        catch (error) {
...
function magentoApiRequestAllItems(propertyName, method, resource, body = {}, query = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const returnData = [];
        let responseData;
        do {
            responseData = yield magentoApiRequest.call(this, method, resource, body, query);
...
exports.sort = sort;
// tslint:disable-next-line: no-any
function getProductAttributes(filter, extraValue) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let attributes = yield magentoApiRequestAllItems.call(this, 'items', 'GET', `/rest/default/V1/products/attributes`, {}, {
            search_criteria: 0,
        });
