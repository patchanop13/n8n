            ...
            loadOptions: {
                ...
                getActivityTypes() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/activityTypes', {});
                ...
                getFilters() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/filters', {}, { type: type[resource] });
                ...
                getOrganizationIds() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/organizations', {});
                ...
                getUserIds() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/users', {});
                ...
                getDeals() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/deals', {});
                ...
                getProducts() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/products', {});
                ...
                getProductsDeal() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', `/deals/${dealId}/products`, {});
                        return (0, GenericFunctions_1.sortOptionParameters)(data.map(({ id, name }) => ({ value: id, name })));
                    });
                },
                ...
                getStageIds() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/stages', {});
                ...
                getOrganizationCustomFields() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/organizationFields', {});
                ...
                getDealCustomFields() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/dealFields', {});
                        for (const field of data) {
                            if (field.key.length === 40) {
                                returnData.push({
                                    name: field.name,
                ...
                getPersonCustomFields() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const returnData = [];
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/personFields', {});
                        for (const field of data) {
                            if (field.key.length === 40) {
                                returnData.push({
                                    name: field.name,
                ...
                getPersons() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/persons', {});
                        return (0, GenericFunctions_1.sortOptionParameters)(data.map(({ id, name }) => ({ value: id, name })));
                    });
                },
                ...
                getLeadLabels() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const { data } = yield GenericFunctions_1.pipedriveApiRequest.call(this, 'GET', '/leadLabels', {});
                        return (0, GenericFunctions_1.sortOptionParameters)(data.map(({ id, name }) => ({ value: id, name })));
                    });
                },
                // Get all the labels to display them to user so that he can
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (['get', 'getAll', 'update'].includes(operation) && ['activity', 'deal', 'organization', 'person', 'product'].includes(resource)) {
                ...
                if (getCustomProperties === true) {
                    customProperties = yield GenericFunctions_1.pipedriveGetCustomProperties.call(this, resource);
                }
            }
            for (let i = 0; i < items.length; i++) {
                ...
                try {
                    ...
                    let responseData;
                    if (returnAll === true) {
                        responseData = yield GenericFunctions_1.pipedriveApiRequestAllItems.call(this, requestMethod, endpoint, body, qs);
                    }
                    else {
                        if (customProperties !== undefined) {
                            (0, GenericFunctions_1.pipedriveEncodeCustomProperties)(customProperties, body);
                        }
                        responseData = yield GenericFunctions_1.pipedriveApiRequest.call(this, requestMethod, endpoint, body, qs, formData, downloadFile);
                    }
                    if (resource === 'file' && operation === 'download') {
                        ...
                        items[i] = newItem;
                        const binaryPropertyName = this.getNodeParameter('binaryPropertyName', i);
                        items[i].binary[binaryPropertyName] = yield this.helpers.prepareBinaryData(responseData.data);
                    }
                    else {
            ...
            if (customProperties !== undefined) {
                for (const item of returnData) {
                    yield (0, GenericFunctions_1.pipedriveResolveCustomProperties)(customProperties, item);
                }
            }
            if (resource === 'file' && operation === 'download') {
