        ...
        for (let i = 0; i < items.length; i++) {
            ...
            try {
                if (syncroMsp.resource === 'customer') {
                    operationResult.push(...yield customer[syncroMsp.operation].execute.call(this, i));
                }
                else if (syncroMsp.resource === 'ticket') {
                    operationResult.push(...yield ticket[syncroMsp.operation].execute.call(this, i));
                }
                else if (syncroMsp.resource === 'contact') {
                    operationResult.push(...yield contact[syncroMsp.operation].execute.call(this, i));
                }
                else if (syncroMsp.resource === 'rmm') {
                    operationResult.push(...yield rmm[syncroMsp.operation].execute.call(this, i));
                }
            }
            catch (err) {
