...
test('user-management:reset should reset DB to default user state', () => __awaiter(void 0, void 0, void 0, function* () {
    yield testDb.createUser({ globalRole: globalOwnerRole });
    yield reset_1.Reset.run();
    const user = yield src_1.Db.collections.User.findOne({ globalRole: globalOwnerRole });
    if (!user) {
