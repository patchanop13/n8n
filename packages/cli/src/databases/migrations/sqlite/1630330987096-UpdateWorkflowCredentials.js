...
const migrationHelpers_2 = require("../../utils/migrationHelpers");
...
class UpdateWorkflowCredentials1630330987096 {
    ...
    up(queryRunner) {
		...
		`;
            // @ts-ignore
            yield (0, migrationHelpers_2.runChunked)(queryRunner, workflowsQuery, (workflows) => {
		...
		`;
            // @ts-ignore
            yield (0, migrationHelpers_2.runChunked)(queryRunner, waitingExecutionsQuery, (waitingExecutions) => {
                ...
                waitingExecutions.forEach((execution) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (credentialsUpdated) {
                        const [updateQuery, updateParams] = queryRunner.connection.driver.escapeQueryWithParameters(`
								...
								WHERE id = '${execution.id}'
							`, { data: JSON.stringify(data) }, {});
                        yield queryRunner.query(updateQuery, updateParams);
                    }
                }));
            });
            const retryableExecutions = yield queryRunner.query(`
